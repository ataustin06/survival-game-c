...
showPartialRedistributionPreferenceQuestion ()
{
    ...
    const answers = Phaser.Utils.Array.Shuffle([
        'Any person with more than 5 units of food should share their extra food with another person who needs more food to survive.',
        'Each member of the group should keep the pieces of food he collected.'
    ]);
...
showRedistributionRulesQuestion ()
{
   ...
   const options = Phaser.Utils.Array.Shuffle([
    ...
    {
        label: 'Any person with more than 5 units of food should share their extra food with another person who needs more food to survive.',
