    ...
    showTotalFoodEstimateQuestion ()
{
    ...
    let answers =
    [
        'More than 12 pieces of food',
        'Exactly 12 pieces of food',
        'Less than 12 pieces of food'
    ];
...
saveGameDataToGoogleSheets ()
{
    const googleScriptUrl =
        'https://script.google.com/macros/s/AKfycbxbqbnyBq6pvIIMPyd7JtDS0BP4y-TKx6x-weCja12PWOm_BODCZQgrt-qWq8hMVRSS/exec';
